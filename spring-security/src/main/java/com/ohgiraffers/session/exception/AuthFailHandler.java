 ...
 *  원래 AuthenticationFailureHandler 구현해야 하지만, 기존에 구현이 되어있는 SimpleUrlAuthenticationFailureHandler을
...
public class AuthFailHandler extends SimpleUrlAuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest req, HttpServletResponse res, AuthenticationException exception)
        ...
        } else if (exception instanceof UsernameNotFoundException) {    // Username = ID
